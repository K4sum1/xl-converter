...
@pytest.fixture
def app(qtbot):
    with patch("ui.tabs.modify_tab.WidgetManager.loadState"),        patch("ui.tabs.modify_tab.WidgetManager.saveState"):
        tab = ModifyTab(
            {
...
def test__updateFileFormat(file_format, enabled, app):
    ...
    with patch.object(app.metadata_cmb, "setEnabled") as mock_metadata_cmb_setEnabled,        patch.object(app.metadata_l, "setEnabled") as mock_metadata_l_setEnabled:
